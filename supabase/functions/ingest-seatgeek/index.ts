...
// Single-file (city list inlined) so it can be deployed by pasting into the
// Supabase dashboard function editor — no second file needed.
// Runs on a cron (see EVENTS.md §Ingest).
// Deploy:  paste into a new dashboard function named "ingest-seatgeek"
//          (or: supabase functions deploy ingest-seatgeek)
